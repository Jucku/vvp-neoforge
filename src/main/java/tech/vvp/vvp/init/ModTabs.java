...
public class ModTabs {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> NATO_VEHICLE_TAB = TABS.register("nato_tab", () -> CreativeModeTab.builder()
            ...
            .displayItems((parameters, output) -> {
                ...
                output.accept(ContainerBlockItem.createInstance(ModEntities.NH_90.get()));

            })
            .build());

    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> RU_VEHICLE_TAB = TABS.register("ru_tab",
    ...
    @EventBusSubscriber(modid = VVP.MOD_ID, bus = EventBusSubscriber.Bus.MOD)
