...
public class Bmp2MModel extends VvpVehicleModel<Bmp2MEntity> {
    ...
    @Override
    public @Nullable TransformContext<Bmp2MEntity> collectTransform(String boneName) {
        TransformContext<Bmp2MEntity> recoil = CannonRecoilTransforms.match(boneName, "dulo_bmp2m");
        if (recoil != null) {
            return recoil;
        }
