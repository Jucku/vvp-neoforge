...
public class PumaModel extends VvpVehicleModel<PumaEntity> {
    ...
    @Override
    public @Nullable TransformContext<PumaEntity> collectTransform(String boneName) {
        TransformContext<PumaEntity> recoil = CannonRecoilTransforms.match(
                boneName, "dulo", CannonRecoilTransforms.Profile.LIGHT);
        if (recoil != null) {
            return recoil;
        }
