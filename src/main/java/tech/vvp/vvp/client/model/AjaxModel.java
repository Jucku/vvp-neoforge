...
public class AjaxModel extends VvpVehicleModel<AjaxEntity> {
    ...
    @Override
    public @Nullable TransformContext<AjaxEntity> collectTransform(String boneName) {
        TransformContext<AjaxEntity> recoil = CannonRecoilTransforms.matchBarrelForWeapon(boneName, "Cannon");
        if (recoil != null) {
            return recoil;
        }
