...
public class Leopard2A7VModel extends VvpVehicleModel<Leopard2A7VEntity> {
    ...
    @Override
    public @Nullable TransformContext<Leopard2A7VEntity> collectTransform(String boneName) {
        TransformContext<Leopard2A7VEntity> recoil = CannonRecoilTransforms.matchBarrel(boneName);
        if (recoil != null) {
            return recoil;
        }
