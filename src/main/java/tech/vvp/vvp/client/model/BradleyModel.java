...
public class BradleyModel extends VvpVehicleModel<BradleyEntity> {
    ...
    @Override
    public @Nullable TransformContext<BradleyEntity> collectTransform(String boneName) {
        TransformContext<BradleyEntity> recoil = CannonRecoilTransforms.matchBarrel(boneName);
        if (recoil != null) {
            return recoil;
        }
