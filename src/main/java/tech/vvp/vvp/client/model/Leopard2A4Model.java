...
public class Leopard2A4Model extends VvpVehicleModel<Leopard2A4Entity> {
    ...
    public @Nullable TransformContext<Leopard2A4Entity> collectTransform(String boneName) {
        TransformContext<Leopard2A4Entity> recoil = CannonRecoilTransforms.matchBarrel(boneName);
        if (recoil != null) {
            return recoil;
        }
