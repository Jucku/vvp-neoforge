...
public class T72B3MModel extends VvpVehicleModel<T72B3MEntity> {
    ...
    @Override
    public @Nullable TransformContext<T72B3MEntity> collectTransform(String boneName) {
        TransformContext<T72B3MEntity> recoil = CannonRecoilTransforms.matchBarrel(boneName);
        if (recoil != null) {
            return recoil;
        }
