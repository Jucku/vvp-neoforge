...
import tech.vvp.vvp.network.message.send.SeatSwapMessage;
...
public class RadialSeatScreen extends Screen {
    ...
    private void drawSector(GuiGraphics graphics, int cx, int cy, int innerR, int outerR,
        ...
        for (int i = 0; i <= segments; i++) {
            ...
            consumer.addVertex(matrix, cx + cos * innerR, cy + sin * innerR, 0)
                    .setColor(r, g, b, a);
            consumer.addVertex(matrix, cx + cos * outerR, cy + sin * outerR, 0)
                    .setColor(r, g, b, a);
        }
