...
public class PantsirOperatorOverlay {
    ...
    private static void drawFilledCircle(PoseStack poseStack, int cx, int cy, int radius, int color) {
        ...
        consumer.addVertex(matrix, cx, cy, 0)
                .setColor(r, g, b, a);
    ...
    private static void drawLine(PoseStack poseStack, int x1, int y1, int x2, int y2, int color, int width) {
        ...
        consumer.addVertex(matrix, x1, y1, 0)
                .setColor(r, g, b, a);
        consumer.addVertex(matrix, x2, y2, 0)
                .setColor(r, g, b, a);
    ...
    private static void drawTriangle(PoseStack poseStack, int x1, int y1, int x2, int y2, int x3, int y3, int color) {
        ...
        consumer.addVertex(matrix, x2, y2, 0)
                .setColor(r, g, b, a);
        consumer.addVertex(matrix, x3, y3, 0)
                .setColor(r, g, b, a);
     ...
     */
    private static void drawDashedLine(PoseStack poseStack, int x1, int y1, int x2, int y2,
        ...
        while (pos < length) {
            if (drawing) {
                ...
                consumer.addVertex(matrix, (float) startX, (float) startY, 0)
                        .setColor(r, g, b, a);
                consumer.addVertex(matrix, (float) endX, (float) endY, 0)
                        .setColor(r, g, b, a);
